...
const RANDOM_ENVIRONMENT_ASSETS = [
  { id: 'modCedar1', use: true, scale: 0.1, frequency: 1 },
  { id: 'modCedar2', use: true, scale: 0.1, frequency: 1 },
  { id: 'modOak1', use: true, scale: 0.1, frequency: 1 },
  { id: 'modOak2', use: true, scale: 0.1, frequency: 1 },
  { id: 'modOak3', use: true, scale: 0.1, frequency: 1 },
  { id: 'modOak4', use: true, scale: 0.1, frequency: 1 },
  { id: 'modPine1', use: true, scale: 0.1, frequency: 1 },
  { id: 'modPine2', use: true, scale: 0.1, frequency: 1 },
  { id: 'modPine3', use: true, scale: 0.1, frequency: 1 },
