  ...
  if (cached === undefined) {
    cached = (async () => {
      ...
      if (import.meta.env.DEV && shouldRunBootContractTests()) {
        ...
        const { runLocalGameConnectionContractTest } = await import('../server/LocalGameConnectionContractTest');
        runLocalGameConnectionContractTest();
        ...
        const { runFormikOrnament3DContractTest } = await import('../render3d/FormikOrnament3DContractTest');
        runFormikOrnament3DContractTest();
