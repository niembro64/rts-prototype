...
import __wbg_init, {
  ...
  pathfinder_class_graph_evictions,
  ...
  if (cached === undefined) {
    cached = (async () => {
      ...
      const handle: SimWasm = {
        ...
        liquidSurfaceSetEnabled: liquid_surface_set_enabled,
        ...
        pathfinder: {
          ...
          classGraphEvictions: pathfinder_class_graph_evictions,
      ...
      if (import.meta.env.DEV && shouldRunBootContractTests()) {
        ...
        const { runGameCanvasChromeStateDefaultsContractTest } = await import('../../components/gameCanvasChromeStateDefaultsContractTest');
        ...
        const { runSensorSignatureRig3DContractTest } = await import('../render3d/SensorSignatureRig3DContractTest');
        ...
        const {
          ...
          runSurfaceTorpedoTowerVerticalContractTest,
          runTurretHostIntegrationContractTest,
        } = await import('../sim/turretHostIntegrationTest');
        runProjectileGuidanceCadenceContractTest();
        runSurfaceTorpedoTowerVerticalContractTest();
        runTurretHostIntegrationContractTest();
        ...
        const { runTurretRestSlopePitchContractTest } = await import('../sim/turretRestSlopePitchContractTest');
