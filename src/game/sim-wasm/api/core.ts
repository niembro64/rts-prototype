...
export interface SimWasm {
  ...
  readonly airborneReturnStepBatch: (
    slots: Uint32Array,
    dx: Float64Array,
    dy: Float64Array,
    distance: Float64Array,
    ...
    committedRadius: Float64Array,
    flags: Uint8Array,
    lastCheckDistance: Float64Array,
    stallChecks: Uint8Array,
    fallbackVelocityX: Float64Array,
    fallbackVelocityY: Float64Array,
    outThrustX: Float64Array,
    outThrustY: Float64Array,
    outState: Uint8Array,
    outHeadingX: Float64Array,
    outHeadingY: Float64Array,
    outRadius: Float64Array,
    outCheckDistance: Float64Array,
    outStallChecks: Uint8Array,
    minTurnRadius: number,
    maxTurnRadius: number,
    enterMargin: number,
    exitRadiusRatio: number,
    progressEpsilon: number,
    stallCheckLimit: number,
    stallAlignDotMax: number,
  ) => number;
