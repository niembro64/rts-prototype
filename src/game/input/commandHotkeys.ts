...
/** Factory production preset slots. Cmd+N loads, Cmd+Alt+N saves — identical
 *  in every hotkey preset, so both tables spread this rather than restating
 *  twenty bindings each and drifting on the next slot added. */
const FACTORY_PRESET_BINDINGS = {
