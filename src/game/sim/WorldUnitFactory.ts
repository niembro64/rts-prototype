...
function createUnitBaseEntity({
  ...
  return {
    ...
    unit: {
      ...
      airborneReturnState: 0,
      airborneReturnHeadingX: 0,
      airborneReturnHeadingY: 0,
      airborneReturnRadius: 0,
      airborneReturnGoalX: null,
      airborneReturnGoalY: null,
      airborneReturnCheckDistance: 0,
      airborneReturnStallChecks: 0,
      velocityX: 0,
      velocityY: 0,
      velocityZ: 0,
      thrustDirX: 0,
