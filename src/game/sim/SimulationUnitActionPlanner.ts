...
export const UNIT_ACTION_PLAN_GUARD_SERVICE_HOLD = 13;
export const UNIT_ACTION_PLAN_GUARD_SERVICE_MOVE = 14;
export const UNIT_ACTION_PLAN_GUARD_FOLLOW = 15;
export const UNIT_ACTION_PLAN_FIGHT_PATROL_HOLD = 16;
export const UNIT_ACTION_PLAN_MOVE_COMPLETION = 17;
