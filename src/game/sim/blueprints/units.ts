...
export const UNIT_BLUEPRINTS: Record<string, UnitBlueprint> = {
  ...
  daddy: {
    ...
    moveSpeed: 200,
    unitDrawScale: 13,
    unitRadiusColliderShot: 13 * 2,
    unitRadiusColliderPush: 13 * 2,
    mass: 25,
    baseCost: 500,
  ...
  widow: {
    ...
    moveSpeed: 70,
    unitDrawScale: 30,
    unitRadiusColliderShot: 40,
    unitRadiusColliderPush: 40,
    mass: 200,
    baseCost: 3000,
    weapons: [
  ...
  hippo: {
    ...
    moveSpeed: 55,
    unitDrawScale: 30,
    unitRadiusColliderShot: 45,
    unitRadiusColliderPush: 45,
    mass: 1500,
    baseCost: 5000,
    weapons: [
