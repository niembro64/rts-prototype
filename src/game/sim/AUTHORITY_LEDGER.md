...
| Packed and guided projectile motion kernels | WASM projectile pool packed stepping, non-packed constant-acceleration integration, homing thrust, and terrain-follow vertical thrust kernels | TypeScript still owns projectile entity lifecycle, homing target policy/intercept setup, D-gun terrain-height sampling, collision handling, death events, and network spawn/despawn/velocity-update events |
