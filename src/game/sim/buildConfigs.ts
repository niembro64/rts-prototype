...
export const UNIT_BUILD_CONFIGS: Record<string, UnitBuildConfig> = {
  scout: {
    ...
    radius: UNIT_STATS.scout.radius,
  ...
  burst: {
    ...
    radius: UNIT_STATS.burst.radius,
  ...
  brawl: {
    ...
    radius: UNIT_STATS.brawl.radius,
  ...
  mortar: {
    ...
    radius: UNIT_STATS.mortar.radius,
  ...
  snipe: {
    ...
    radius: UNIT_STATS.snipe.radius,
