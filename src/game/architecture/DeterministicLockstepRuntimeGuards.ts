...
const REQUIRED_LOCKSTEP_WASM_KERNELS: readonly RequiredKernel[] = [
  ...
  ['deterministicMath.ln', (sim) => sim.deterministicMath.ln],
  ['deterministicMath.log2', (sim) => sim.deterministicMath.log2],
  ['deterministicMath.tan', (sim) => sim.deterministicMath.tan],
  ['deterministicMath.asin', (sim) => sim.deterministicMath.asin],
  ...
  ['articulationJointStepBatch', (sim) => sim.articulationJointStepBatch],
