...
} = createSelectionPanelStateHelpers(
  () => isBarHotkeyPreset.value,
  () => visibleTrajectoryStateCount.value,
);
...
const BAR_GROUP_ICON_BY_STRUCTURE_BLUEPRINT_ID: Partial<Record<StructureBlueprintId, BarGroupIconId>> = {
  ...
  buildingRadar: 'util',
  buildingSonar: 'util',
  buildingRadarJammer: 'util',
  buildingSonarJammer: 'util',
  buildingMetalStorage: 'metal',
  buildingEnergyStorage: 'energy',
...
function emptyGridCells<T>(): (T | null)[] {
  return new Array<T | null>(BAR_GRID_SLOT_COUNT).fill(null);
}
...
<style scoped src="./selectionPanelBase.css"></style>
<style scoped src="./selectionPanelBuildMenu.css"></style>
