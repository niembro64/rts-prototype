 ...
 *  `meshTriangleWallFlags` is a D-PLATEAU wall-region bit on the final mesh:
 *  1 for triangles emitted by explicit wall strips or whose centroid resolves
 *  to an odd plateau wall band after conforming repair.
