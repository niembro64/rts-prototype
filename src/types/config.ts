...
export type ShieldImpactVisualConfig = {
...
export type ShieldTurretConfig = {
  shape: ShieldTurretShape;
  count: number;
  length: number;
  width: number;
  taper: number;
...
// FRACTIONS of the turret's body sphere radius (= TurretBlueprint.radius.visual);
