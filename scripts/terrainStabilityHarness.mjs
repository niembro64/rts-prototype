...
const CASES = [
  ...
  {
    id: '15x15-circle-plateau400-wall70-detail10-4p',
    widthLandCells: 15,
    heightLandCells: 15,
    playerCount: 4,
    terrainMapShape: 'circle',
  ...
  {
    id: '15x15-circle-plateau400-detail32-4p',
    widthLandCells: 15,
    heightLandCells: 15,
    playerCount: 4,
    terrainMapShape: 'circle',
...
function summarizeTerrain(map) {
  return {
    ...
    meshTriangleWallFlags: {
      ...summarizeNumberArray(map.meshTriangleWallFlags),
      sum: map.meshTriangleWallFlags.reduce((acc, value) => acc + value, 0),
    },
  ...
  try {
    ...
    for (const testCase of CASES) {
      ...
      terrain.setTerrainRuntimeConfig({
        ...
        perimeterMagnitude: testCase.perimeterMagnitude,
        terrainDTerrain: testCase.terrainDTerrain,
        plateauWallSlopeDegrees: testCase.plateauWallSlopeDegrees,
