...
const UNIT_ACTION_PLAN_GUARD_SERVICE_HOLD: u8 = 13;
const UNIT_ACTION_PLAN_GUARD_SERVICE_MOVE: u8 = 14;
const UNIT_ACTION_PLAN_GUARD_FOLLOW: u8 = 15;
const UNIT_ACTION_PLAN_FIGHT_PATROL_HOLD: u8 = 16;
const UNIT_ACTION_PLAN_MOVE_COMPLETION: u8 = 17;
